...
# TODO_TZ: these should be generated by gen_py.py

def distr_bernoulli(name, **params):
    return core.distr('bernoulli', params)

# def distr_binomial(name, **params):
#     return core.distr('binomial', params)
